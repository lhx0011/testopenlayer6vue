...
export default {
  ...
  methods: {
    ...
    loadArcJsFile() {
      ...
      // link2.setAttribute('href', './static/css/map.style.css')
    ...
    initMap() {
      ...
      var url = 'http://localhost:9000/ocean/gis/getSurveyStation/'+ that.uuid;
...
<!--<style src="./style/css/map.style.css"></style>-->
<style >
